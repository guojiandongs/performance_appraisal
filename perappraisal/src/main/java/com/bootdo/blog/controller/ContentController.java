...
public class ContentController extends BaseController {
	...
	@GetMapping("/editnew")
	String enditnew() {
		return "blog/bContent/bContentnew";
	}
...
//	@GetMapping("/addm")
//	@RequiresPermissions("blog:bContent:add")
//	String madd() { return "blog/bContent/addm"; }


	@GetMapping("/addnew")
	@RequiresPermissions("blog:bContent:add")
	String addnew() {
		return "blog/bContent/addnew";
	}
	...
	@GetMapping("/editnew/{cid}")
	@RequiresPermissions("blog:bContent:edit")
	String editnew(@PathVariable("cid") Long cid, Model model) {
		ContentDO bContentDO = bContentService.get(cid);
		model.addAttribute("bContent", bContentDO);
		return "blog/bContent/editnew";
	}
	@GetMapping("/editm/{cid}")
	@RequiresPermissions("blog:bContent:edit")
	String editm(@PathVariable("cid") Long cid, Model model) {
		ContentDO bContentDO = bContentService.get(cid);
		//model.addAttribute("bContent", bContentDO);
		return "blog/bContent/editm";
	}
